...
import data from 'datas/portfolio/HanaCapital';

import * as styles from './HanaCapital.module.scss';
styles = stylesCopyConvertDashes(styles);
const cx = classNames.bind(styles);

const imagesSrc = importImages(require.context('./images/', false, /\.(png|jpe?g|gif)$/));

class HanaCapital extends Component {
  render() {
    return (
