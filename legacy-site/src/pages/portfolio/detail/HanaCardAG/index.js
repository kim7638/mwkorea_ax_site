    ...
    return (
      <PortfolioLayout data={data}>
        <div className={cx('contents')}>
          ...
          <img src={imagesSrc['tablet-5.jpg']} alt="" className="is-tablet-only" />
          <img src={imagesSrc['tablet-6.jpg']} alt="" className="is-tablet-only" />
          ...
          <img src={imagesSrc['mobile-6.jpg']} alt="" className="is-mobile-only" />
        </div>
      </PortfolioLayout>
    );
  }
